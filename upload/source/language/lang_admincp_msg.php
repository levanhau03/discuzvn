...
$lang = array (
	...
	'patch_successful' => 'Hoạt động thành công',//'操作成功',
	'plugin_not_found' => 'Không tìm thấy plugin',//'插件未找到',
	...
	'plugin_file_error' => 'Không tìm thấy tệp plugin',//'插件文件缺失',
	...
	'plugins_delete_succeed' => 'Plugin gỡ cài đặt thành công!<br />Để gỡ cài đặt đúng trình cắm này, bạn cũng có thể cần phải xóa hoặc sửa đổi các tệp hoặc mẫu thích hợp',//'插件成功卸载！<br />为了正常卸载此插件，您可能还需要删除或修改相应的文件或模板，详情请查看本插件的安装说明',
