...
$lang = array (
	...
	'blockstyle_delete_succeed' => 'Block style removed successfully.',
	'blogcategory_move_category_failed' => 'Không thể di chuyển blog đến danh mục đã chỉ định',
	'blogcategory_delete_succeed' => 'Blog category removed successfully.',
	'filecheck_nofound_md5file' => 'Checked file does not exist, can not do this.',
	'cloudaddons_download_error' => 'Data download error',
	'cloudaddons_downloading' => 'Application {addonid} downloading, please wait...',
	'collection_admin_updated' => 'Collection managed successfully',
	'counter_member_succeed' => 'User post counter was rebuilt.',
	'credits_update_succeed' => 'Points rules updated successfully.',
	'noaccess_isfounder' => 'You do not have permission to access to the settings area. For security reasons only the site founder can access the settings. Please check the config/config_global.php file for founder settings.',
	'database_export_multivol_succeed' => 'Congratulations! All {volume} backup files successfully created, backup is completed.<br />{filelist}',
	'database_export_zip_succeed' => 'Backup data successfully compressed and saved to the server <a href="{filename}">{filename}</a>.',
	'setting_update_succeed' => 'Cài đặt hiện tại được cập nhật thành công.',
