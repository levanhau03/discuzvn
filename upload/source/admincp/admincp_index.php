...
showtableheader('Phát hiện môi trường hoạt động', 'fixpadding');
$env_ok = true;
...
showtableheader('Discuz! Người đóng góp', 'fixpadding');
showtablerow('', array('', 'class="td21" style="text-align:right;"'),
...
showtablerow('', array('class="vtop td24 lineheight"', 'class="lineheight smallfont"'), array(
    ...
    ($newversion['newversion']['release'] ? ($newversion['newversion']['release'] != DISCUZ_RELEASE ? '<b style="color:red;">' : '').'Discuz! '.$newversion['newversion']['version'].' R'.$newversion['newversion']['release'].' '.strtoupper(CHARSET).' '.($newversion['newversion']['release'] != DISCUZ_RELEASE ? '</b>' : '') : '<a href="https://www.dismall.com/thread-73-1-1.html" target="_blank">Máy chủ của bạn không thể phát hiện phiên bản mới, vui lòng nhấp để xem phiên bản mới</a>').
	  ' <a href="'.ADMINSCRIPT.'?action=index&checknewversion&formhash='.$_G['formhash'].'">[ Làm tươi ]</a>&nbsp;&nbsp;<br><br>'.
    (!empty($downlist) ? implode(',', $downlist).($newversion['newversion']['qqqun'] ? '<span class="bold">&nbsp;&nbsp;|&nbsp;&nbsp;Nhóm QQ:'.$newversion['newversion']['qqqun'].'</span>' : '') : '<span class="bold"><a href="https://gitee.com/3dming/DiscuzL/attach_files" target="_blank">Tải xuống phiên bản mới nhất</a> | Nhóm QQ:73'.'21'.'03'.'690</span>')
));
...
showtableheader('Discuz! Tin tức', 'fixpadding left" style="width : 48%; margin-left: 2%; clear: none;', '', '3');
if(!empty($newversion['news'])){
    ...
    showtablerow('', array('', 'class="td21" style="text-align:right;"'), array(
        '<a href="https://www.dismall.com/" target="_blank">Chưa có bản cập nhật nào, vui lòng đăng nhập vào Cộng đồng Discuz! Để xem.</a>',
        '',
    ));
    showtablerow('', array('', 'class="td21" style="text-align:right;"'), array(
        '<a href="https://gitee.com/3dming/DiscuzL/attach_files" target="_blank">Tải xuống phiên bản mới nhất Discuz! X3.4</a>',
        '',
    ));
}
showtablefooter();
...
showtablerow('', array('class="vtop td24 lineheight"'), array(
	...
	'<span class="bold">Tencent Cloud Computing (Bắc Kinh) Co., Ltd.</span>'
));
showtablerow('', array('class="vtop td24 lineheight"', 'class="lineheight smallfont team"'), array(
	cplang('home_dev_manager'),
	'<a href="http://www.discuz.net/home.php?mod=space&uid=1" class="lightlink2 smallfont" target="_blank">Dai Zhikang (Kevin \'Crossday\' Day)</a>'
));
showtablerow('', array('class="vtop td24 lineheight"', 'class="lineheight smallfont team"'), array(
...
showtablerow('', array('class="vtop td24 lineheight"', 'class="lineheight"'), array(
	...
	'<a href="https://www.dismall.com/" class="lightlink2" target="_blank">Discuz! Khu vực thảo luận ứng dụng</a>,
	<a href="http://www.comsenz.com" class="lightlink2" target="_blank">Trang web của công ty</a>,
	<a href="http://www.discuz.net/redirect.php?service" class="lightlink2" target="_blank">Ủy quyền mua hàng</a>,
	<a href="http://www.discuz.net/" class="lightlink2" target="_blank">Diễn đàn</a>,
	<a href="'.ADMINSCRIPT.'?action=cloudaddons" class="lightlink2" target="_blank">Trung tâm ứng dụng Discuz!</a>,
